...
// concat js task - concat and minify JS into the public js folder
gulp.task('js-concat', () => {
  $.fancyLog('-> Concat Javascript...')
  return gulp
    .src(pkg.globs.fullJs)
    .pipe($.plumber({ errorHandler: onError }))
...
// Production build
gulp.task('build', ['download', 'default', 'favicons', 'imagemin', 'fonts'])
