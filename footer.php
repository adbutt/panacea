...
<a href="#page" class="js-trigger top" data-mt-duration="300"><span class="screen-reader-text"><?php echo esc_html_e('Back to top', 'panacea'); ?></span><i class="icon-up-open"></i></a>
